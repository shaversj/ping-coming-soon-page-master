    ...
    <>
        <main className={"max-w-screen-sm lg:max-w-screen-lg min-h-screen mx-auto flex flex-col justify-center font-Libre-Franklin px-[1.725rem]"}>
            ...
            <div className={"pt-[7.75rem] lg:pt-[4.375rem] flex items-center justify-center space-x-2.5"}>
                <div>
                    <SocialIcon network="facebook" fgColor={"#4f7df3"} bgColor={"#FFFFFF"} style={{ height: 31, width: 31 , border: "1px solid #eeeef7", "border-radius": "50%", "-moz-border-radius": "50%", "-webkit-border-radius": "50%"}}/>
                </div>

                <div>
                    <SocialIcon network="twitter" fgColor={"#4f7df3"} bgColor={"#FFFFFF"} style={{ height: 31, width: 31 , border: "1px solid #eeeef7", "border-radius": "50%", "-moz-border-radius": "50%", "-webkit-border-radius": "50%"}}/>
                </div>

                <div>
                    <SocialIcon network="instagram" fgColor={"#4f7df3"} bgColor={"#FFFFFF"} style={{ height: 31, width: 31 , border: "1px solid #eeeef7", "border-radius": "50%", "-moz-border-radius": "50%", "-webkit-border-radius": "50%"}}/>
                </div>
            </div>
